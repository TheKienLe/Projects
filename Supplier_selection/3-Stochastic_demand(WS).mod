...
dexpr float purchasing_cost = sum (s in S)( p[s] * (sum (k in K, i in I, r in R) (1 - delta[i][r] )*f[i][k] *(z[i][k][r][s] + z_plus[i][k][r][s] - z_minus[i][k][r][s])));
...
subject to 
{
  ...
  sum (i in I, r in R) (z[i][k][r][s] + z_plus[i][k][r][s] - z_minus[i][k][r][s]) + ws[k][s] >= d[k] + ddelta[k][s];
  
  con_72:
  forall (k in K, s in S, i in I)
  sum (i in I, r in R) (z[i][k][r][s] + z_plus[i][k][r][s] - z_minus[i][k][r][s]) >= q[i][k];
  ...
  con_77:
  forall (k in K, i in I, r in R, s in S)
  lamda_plus[i][k][r][s] + lamda_minus[i][k][r][s] <= y[i][r][s];
